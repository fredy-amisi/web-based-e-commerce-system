...
// Extract necessary data from the orders array
$orders = $data['orders']; // Assuming 'orders' is sent as an array of objects
$totalAmount = $data['total']; // Total amount to be stored (optional)

$response = array();

// Example SQL query to insert order data into the database
$sql = "INSERT INTO orders ( product, quantity, total_price, order_date, status) VALUES (:product, :quantity, :total_price, NOW(), 'pending')";
